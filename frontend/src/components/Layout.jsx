    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="border-b px-4 py-3 flex items-center gap-3 flex-shrink-0" style={{ background: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
          ...
          <div className="flex flex-col items-center flex-1"><span className="text-sm font-bold tracking-widest uppercase" style={{ color: '#263D4F' }}>Master Baker</span><span className="text-xs tracking-wider" style={{ color: '#C29C53' }}>Sistema de Gestión Inteligente de Panadería</span></div>
