// src/lib/unidades.js
// Biblioteca centralizada y unificada de conversión de unidades físicas
// para Master Baker (Masa, Volumen y Conteo).
...
/**
 * Convierte una cantidad física de una unidad de medida a otra.
 */
export function convertirCantidad(cantidad, uOrigen, uDestino) {
  ...
  if (gramos !== null) {
    ...
    return q // Unidad destino no compatible de masa
  }
  ...
  if (mililitros !== null) {
    ...
    return q // Unidad destino no compatible de volumen
  }
...
/**
 * Convierte un precio de compra unitario basado en una unidad base
 * a la unidad destino correspondiente.
 */
export function convertirPrecio(precioBase, unidadBase, unidadDestino) {
  ...
  // El precio de destino es inversamente proporcional al factor de cantidad:
  // precioDestino = precioBase / factorCantidad
